...
export function FinalCta() {
  return (
    <section className="grain relative overflow-hidden bg-ink py-28 text-paper sm:py-36">
      {/*
        La imagen del cierre va como FRANJA AL PIE, no como fondo de toda la
        sección: es un 16:6 con una sola línea terracota, y a pantalla completa
        esa línea caía justo entre el titular y el botón, partiendo la sección.
        Aquí la línea cierra la página por abajo y se disuelve hacia arriba.
      */}
      {MEDIA.cierre.ready && (
        <div
          aria-hidden="true"
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute bottom-[-18rem] left-1/2 h-[36rem] w-[62rem] -translate-x-1/2 rounded-full opacity-20 blur-3xl"
        style={{
          background:
